...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#"><img src="https://cdn5.vectorstock.com/i/1000x1000/80/84/letter-b-beauty-women-face-logo-design-vector-27938084.jpg"  alt="..." width="40" height="40">BRIDAL EMPORIUM</a>
    ...
    <form action="{{ route('dash.searcha1') }}" method="get">
...
<li class="nav-item">
  ...
  <li class="nav-item">
    <a class="btn btn-two" href="{{ route('dash.mermaidgownsa') }}" style="color:#DEDFE2">MermaidGowns</a>
  </li>
  <li class="nav-item">
...
<div class="container">
      ...
      <h4 class="card-title"> {{ $prod->prname }}</h4>
        ...
        Sizes available:
            ...
            <br>
            Price: {{ $prod->price }}</p>
            <a href="/dash/{{$prod->id}}/update"  class="add-to-cart btn btn-primary">Edit</a>
    
    <a href="/dash/{{$prod->id}}/fdelete"  class="add-to-cart btn btn-primary">Delete</a>
      </div>
    </div>
          </div>
