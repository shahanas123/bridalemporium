...
<li class="nav-item">
 ...
 <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="btn btn-two" href="{{ route('dash.addproduct') }}" style="color:#DEDFE2">Add</a>
  </li>
  <li class="nav-item">
...
<div class="container">
    <div class="row"  >
        ...
        <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6"></div>
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="prname" placeholder="Enter the product name" value="{{ old('prname') }}" required>
                    <span class="text-danger">@error('name'){{ $message }} @enderror</span>
                </div>
                <br>
                <select class="input" name="type" id="type" style="width: 300px; height: 40px;" required>
      ...
      <br>
                ...
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="medium" name="medium" data-value="0" value="2">
                <label class="form-check-label" for="medium">Medium</label>
                </div>
                <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="large" name="large" data-value="0" value="3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="quantity" placeholder="Enter quantity" value="" required>
                    <span class="text-danger">@error('quantity '){{ $message }} @enderror</span>
                </div> 
                <br>
                <div class="form-group">
                    <label>Price</label>
                    <input type="number" class="form-control" name="price" placeholder="Enter price" value="" required>
