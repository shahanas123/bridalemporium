...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="#"><img src="https://cdn5.vectorstock.com/i/1000x1000/80/84/letter-b-beauty-women-face-logo-design-vector-27938084.jpg"  alt="..." width="40" height="40">BRIDAL EMPORIUM</a>
    ...
    <form action="{{ route('dash.searchu') }}" method="get">
...
<li class="nav-item">
    <a class="btn btn-two active" aria-current="page" href="{{ route('dash.ballgownsu') }}" style="color:#DEDFE2" >BallGowns</a>
  </li>
  <li class="nav-item">
...
<div class="container">
      ...
      <h4 class="card-title"> {{ $prod->prname }}</h4>
        ...
        Sizes available:
            ...
            <br>
            Price: {{ $prod->price }}</p>
             <a href="/dash/{{$prod->id}}/addtocart"  class=" btn btn-primary">Add to cart</a>
