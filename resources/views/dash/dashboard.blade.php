...
<li class="nav-item">
    <a class="btn btn-two " aria-current="page" href="{{ route('dash.dashboard') }}" style="color: #DEDFE2" >Home</a>
  </li>
<li class="nav-item">
    <a class="btn btn-one" aria-current="page" href="{{ route('dash.ballgowns') }}" style="color:#DEDFE2" >BallGowns</a>
  </li>
  <li class="nav-item">
    <a class="btn btn-one" href="{{ route('dash.mermaidgowns') }}" style="color:#DEDFE2">MermaidGowns</a>
  </li>
  <li class="nav-item">
    <a class="btn btn-one" href="{{ route('dash.sheathgowns') }}" style="color:#DEDFE2">SheathGowns</a>
  </li>
  <li class="nav-item">
    <a class="btn btn-one" href="{{ route('dash.reviews') }}" style="color:#DEDFE2">Reviews</a>
  </li>
...
<body style="background-color:#F8F9F9 ;">
  ...
  <div class="carousel-inner" data-interval="100">
    <div class="carousel-item active">
      <img src="https://samyakkimg.gumlet.io/magestore/bannerslider/images//0/1/01_7.jpg?w=1536&dpr=1.3" class="d-block w-400" alt="...">
    </div>
    <div class="carousel-item" data-interval="100">
      <img src="https://samyakkimg.gumlet.io/magestore/bannerslider/images//0/6/06_2.jpg?w=1536&dpr=1.3" class="d-block w-400" alt="...">
    </div>
    <div class="carousel-item" data-interval="100">
      <img src="https://samyakkimg.gumlet.io/magestore/bannerslider/images//0/7/07_1.jpg?w=1536&dpr=1.3" class="d-block w-400"  alt="...">
    </div>
  </div>
